...
const onOk = (value: DatePickerProps['value'] | RangePickerProps['value']) => {
 ...
 export const  CreatePlanPage : React.FC = () => {
  ...
  const onFinish =  async (submitResult: any, e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log("这是表单请求体",submitResult);
    const taskid = Math.random().toString(36).substring(2,  10).toUpperCase(); 
    ...
    submitResult.taskid  = taskid;
    submitResult.createdTime  = created_time; 
    submitResult.userid  = userid;
